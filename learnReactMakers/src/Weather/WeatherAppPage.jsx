...
// ─── Fetcher ──────────────────────────────────────────────────────────────────
// SWR akan panggil fetcher(url) secara otomatis, cache hasilnya, dan re-fetch kalau perlu
const fetcher = (url) =>
  fetch(url).then((r) => {
...
function formatHour(dtTxt) {
  // dtTxt: "2024-05-27 15:00:00"
  return dtTxt.slice(11, 16); // "15:00"
}
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{
                          ...
                          width: w.temp === "Coming Soon" ? "100%" : undefined,
                          display:
